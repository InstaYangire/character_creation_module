...
def attack(char_name: str, char_class: str) -> str:
    ...
    return (f'{char_name: str} не нанёс урона противнику')


def defence(char_name: str, char_class: str) -> str:
    """Сalculate the the defence."""
    if char_class == 'warrior':
    ...
    return (f'{char_name: str} не использовал умение блокирования урона')


def special(char_name: str, char_class: str) -> str:
    """Сalculate the special."""
    if char_class == 'warrior':
    ...
    if char_class == 'healer':
        return (f'{char_name: str} применил специальное умение '
                f'«Защита {10 + 30}»')
    return (f'{char_name: str} не применил специального умения')


def start_training(char_name: str, char_class: str) -> str:
    """Сalculate the training."""
    if char_class == 'warrior':
